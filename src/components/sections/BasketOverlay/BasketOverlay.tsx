...
export const BasketOverlay = () => {
  const { showBasket, setShowBasket } = useCheckoutContext();
  ...
  return (
    <section
      ref={overlay}
      className="fixed right-0 top-0 z-50 flex h-screen w-[60vw] bg-[#f3eee8] shadow-[-10px_0px_15px_0px_rgb(0,0,0)] [clip-path:polygon(100%_0,100%_0,100%_100%,100%_100%)] md:w-[30vw]"
    >
