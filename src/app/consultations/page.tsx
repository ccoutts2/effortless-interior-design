...
const Page = () => {
  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center p-4 md:gap-16 md:px-12 lg:flex-row lg:items-start lg:justify-start lg:px-32">
        <div className="flex-1 md:flex-[1.5]">
          <h3 className="text-xl md:text-2xl">
            Get 1:1 guidance, new ideas and solutions to your interiors problems
          </h3>
          <WorkshopsParagraphs paragraph="I'm delighted to be offering 1:1 consultations, both online and in person. A consultation with me will give you answers to all your interiors questions, plus lots of new ideas, product recommendations and confidence in your next steps." />
          <WorkshopsParagraphs paragraph="I am able to provide you with innovative and practical solutions to your design dilemmas; I am passionate about empowering you to create the home you've always wanted, by offering useful advice and solutions that may not have occurred to you before, and introducing you to new suppliers that sell exactly what you need." />
        ...
        <div className="flex-1 pt-6 md:pt-0">
          ...
          <WorkshopsParagraphs paragraph="To book an online or in-person consultation, please get in touch to tell me about your project. Please include information on which rooms you would like to discuss and the key areas you would like advice on." />
